...
class _TipDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Dialog(
      // Le fond de l'app : la bordure blanche à 8 % suffit à détacher la
      // popup de la page. (Avant, SC.bg était bleu nuit et la popup se
      // fondait dans le fond — d'où un gris codé en dur ici.)
      backgroundColor: SC.bg,
