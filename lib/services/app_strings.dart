...
abstract final class AppStrings {
  ...
  static const Map<String, String> _fr = {
    ...
    'stt_dl_title': 'Traduction hors ligne',
    'stt_dl_body': 'Ta voix est transcrite directement sur ton téléphone. Le modèle fait {mb} Mo — mieux vaut le télécharger maintenant qu\'au milieu de ton premier appel.',
    'stt_dl_now': 'Télécharger',
    'stt_dl_later': 'Plus tard',
    'stt_dl_failed': 'Le téléchargement a échoué. Il sera retenté à ton premier appel.',
  ...
  static const Map<String, String> _en = {
    ...
    'stt_dl_title': 'Offline translation',
    'stt_dl_body': 'Your voice is transcribed on your phone. The model is {mb} MB — better to download it now than in the middle of your first call.',
    'stt_dl_now': 'Download',
    'stt_dl_later': 'Later',
    'stt_dl_failed': 'The download failed. It will be retried on your first call.',
  ...
  static const Map<String, String> _es = {
    ...
    'stt_dl_title': 'Traducción sin conexión',
    'stt_dl_body': 'Tu voz se transcribe en tu teléfono. El modelo ocupa {mb} MB: mejor descargarlo ahora que en mitad de tu primera llamada.',
    'stt_dl_now': 'Descargar',
    'stt_dl_later': 'Más tarde',
    'stt_dl_failed': 'La descarga falló. Se reintentará en tu primera llamada.',
  ...
  static const Map<String, String> _de = {
    ...
    'stt_dl_title': 'Übersetzung offline',
    'stt_dl_body': 'Deine Stimme wird direkt auf deinem Handy transkribiert. Das Modell ist {mb} MB groß — lade es lieber jetzt herunter als mitten in deinem ersten Anruf.',
    'stt_dl_now': 'Herunterladen',
    'stt_dl_later': 'Später',
    'stt_dl_failed': 'Der Download ist fehlgeschlagen. Er wird bei deinem ersten Anruf wiederholt.',
  ...
  static const Map<String, String> _it = {
    ...
    'stt_dl_title': 'Traduzione offline',
    'stt_dl_body': 'La tua voce viene trascritta sul telefono. Il modello pesa {mb} MB: meglio scaricarlo ora che durante la tua prima chiamata.',
    'stt_dl_now': 'Scarica',
    'stt_dl_later': 'Più tardi',
    'stt_dl_failed': 'Download non riuscito. Verrà ritentato alla tua prima chiamata.',
  ...
  static const Map<String, String> _pt = {
    ...
    'stt_dl_title': 'Tradução offline',
    'stt_dl_body': 'A tua voz é transcrita no teu telemóvel. O modelo tem {mb} MB — é melhor descarregá-lo agora do que a meio da tua primeira chamada.',
    'stt_dl_now': 'Descarregar',
    'stt_dl_later': 'Mais tarde',
    'stt_dl_failed': 'A transferência falhou. Será repetida na tua primeira chamada.',
  ...
  static const Map<String, String> _nl = {
    ...
    'stt_dl_title': 'Vertaling offline',
    'stt_dl_body': 'Je stem wordt op je telefoon getranscribeerd. Het model is {mb} MB — download het liever nu dan midden in je eerste gesprek.',
    'stt_dl_now': 'Downloaden',
    'stt_dl_later': 'Later',
    'stt_dl_failed': 'Downloaden mislukt. Het wordt opnieuw geprobeerd bij je eerste gesprek.',
  ...
  static const Map<String, String> _ar = {
    ...
    'stt_dl_title': 'الترجمة دون اتصال',
    'stt_dl_body': 'يتم تحويل صوتك إلى نص على هاتفك مباشرة. حجم النموذج {mb} ميغابايت — من الأفضل تنزيله الآن بدل أن يحدث ذلك في منتصف مكالمتك الأولى.',
    'stt_dl_now': 'تنزيل',
    'stt_dl_later': 'لاحقًا',
    'stt_dl_failed': 'فشل التنزيل. ستتم إعادة المحاولة في مكالمتك الأولى.',
  ...
  static const Map<String, String> _ru = {
    ...
    'stt_dl_title': 'Перевод офлайн',
    'stt_dl_body': 'Твой голос распознаётся прямо на телефоне. Модель весит {mb} МБ — лучше скачать её сейчас, чем посреди первого звонка.',
    'stt_dl_now': 'Скачать',
    'stt_dl_later': 'Позже',
    'stt_dl_failed': 'Не удалось скачать. Попробуем снова при первом звонке.',
  ...
  static const Map<String, String> _zh = {
    ...
    'stt_dl_title': '离线翻译',
    'stt_dl_body': '你的语音会直接在手机上转写。模型大小为 {mb} MB——现在下载比在第一次通话中途下载更好。',
    'stt_dl_now': '下载',
    'stt_dl_later': '稍后',
    'stt_dl_failed': '下载失败，将在你第一次通话时重试。',
  ...
  static const Map<String, String> _ja = {
    ...
    'stt_dl_title': 'オフライン翻訳',
    'stt_dl_body': 'あなたの声はスマホの中で文字起こしされます。モデルは {mb} MB です。最初の通話の途中よりも、今ダウンロードしておくほうが安心です。',
    'stt_dl_now': 'ダウンロード',
    'stt_dl_later': 'あとで',
    'stt_dl_failed': 'ダウンロードに失敗しました。最初の通話時に再試行します。',
  ...
  static const Map<String, String> _ko = {
    ...
    'stt_dl_title': '오프라인 번역',
    'stt_dl_body': '목소리는 휴대폰 안에서 바로 텍스트로 변환됩니다. 모델 크기는 {mb} MB입니다. 첫 통화 도중보다 지금 내려받는 편이 좋습니다.',
    'stt_dl_now': '다운로드',
    'stt_dl_later': '나중에',
    'stt_dl_failed': '다운로드에 실패했습니다. 첫 통화 때 다시 시도합니다.',
