...
abstract final class AppStrings {
  ...
  static const Map<String, String> _fr = {
    ...
    'globe_launch': 'Voir les profils',
    'globe_filter_cta': 'Filtrer',
    'globe_hint': 'Touche un ou plusieurs pays. Pince pour zoomer.',
    ...
    'demandes_wants_to_match': '{name} t\'a envoyé une demande',
    ...
    'call_lang_check_q': "Tu es sûr d'avoir sélectionné la bonne langue ?",
    'call_lang_check_change': 'Changer la langue',
    'call_lang_check_keep': "C'est la bonne",
  ...
  static const Map<String, String> _en = {
    ...
    'country_fr': 'France',
    'country_de': 'Germany',
    'globe_launch': 'See profiles',
    'globe_filter_cta': 'Filter',
    'globe_hint': 'Tap one or more countries. Pinch to zoom.',
    ...
    'demandes_wants_to_match': '{name} sent you a request',
    ...
    'call_lang_check_q': 'Are you sure you picked the right language?',
    'call_lang_check_change': 'Change language',
  ...
  static const Map<String, String> _es = {
    ...
    'country_fr': 'Francia',
    'country_de': 'Alemania',
    'globe_launch': 'Ver perfiles',
    'globe_filter_cta': 'Filtrar',
    'globe_hint': 'Toca uno o varios países. Pellizca para acercar.',
    ...
    'demandes_wants_to_match': '{name} te envió una solicitud',
    ...
    'call_lang_check_q': '¿Seguro que elegiste el idioma correcto?',
    'call_lang_check_change': 'Cambiar idioma',
  ...
  static const Map<String, String> _de = {
    ...
    'globe_launch': 'Profile ansehen',
    'globe_filter_cta': 'Filtern',
    'globe_hint': 'Tippe ein oder mehrere Länder an. Zwei Finger zum Zoomen.',
    ...
    'demandes_wants_to_match': '{name} hat dir eine Anfrage geschickt',
    ...
    'call_lang_check_q': 'Hast du wirklich die richtige Sprache gewählt?',
    'call_lang_check_change': 'Sprache ändern',
    'call_lang_check_keep': 'Sie ist richtig',
  ...
  static const Map<String, String> _it = {
    ...
    'country_fr': 'Francia',
    'country_de': 'Germania',
    'globe_launch': 'Vedi i profili',
    'globe_filter_cta': 'Filtra',
    'globe_hint': 'Tocca uno o più paesi. Pizzica per lo zoom.',
    ...
    'demandes_wants_to_match': '{name} ti ha inviato una richiesta',
    ...
    'call_lang_check_q': 'Sei sicuro di aver scelto la lingua giusta?',
    'call_lang_check_change': 'Cambia lingua',
  ...
  static const Map<String, String> _pt = {
    ...
    'country_fr': 'França',
    'country_de': 'Alemanha',
    'globe_launch': 'Ver perfis',
    'globe_filter_cta': 'Filtrar',
    'globe_hint': 'Toca num ou mais países. Belisca para ampliar.',
    ...
    'demandes_wants_to_match': '{name} enviou-te um pedido',
    ...
    'call_lang_check_q': 'Tens a certeza de que escolheste o idioma certo?',
    'call_lang_check_change': 'Mudar idioma',
  ...
  static const Map<String, String> _nl = {
    ...
    'globe_launch': 'Profielen bekijken',
    'globe_filter_cta': 'Filteren',
    'globe_hint': 'Tik op één of meer landen. Knijp om te zoomen.',
    ...
    'match_cta': 'Match',
    'match_matched': 'Gematcht',
    'demandes_wants_to_match': '{name} heeft je een verzoek gestuurd',
    ...
    'call_lang_check_q': 'Weet je zeker dat je de juiste taal hebt gekozen?',
    'call_lang_check_change': 'Taal wijzigen',
  ...
  static const Map<String, String> _ar = {
    ...
    'country_fr': 'فرنسا',
    'country_de': 'ألمانيا',
    'globe_launch': 'عرض الملفات',
    'globe_filter_cta': 'تصفية',
    'globe_hint': 'المس دولة واحدة أو أكثر. اقرص للتكبير.',
    ...
    'demandes_wants_to_match': '{name} أرسل لك طلبًا',
    ...
    'call_lang_check_q': 'هل أنت متأكد أنك اخترت اللغة الصحيحة؟',
    'call_lang_check_change': 'تغيير اللغة',
  ...
  static const Map<String, String> _ru = {
    ...
    'country_fr': 'Франция',
    'country_de': 'Германия',
    'globe_launch': 'Смотреть профили',
    'globe_filter_cta': 'Фильтр',
    'globe_hint': 'Коснитесь одной или нескольких стран. Щипок для масштаба.',
    ...
    'demandes_wants_to_match': '{name} отправил(а) тебе запрос',
    ...
    'call_lang_check_q': 'Вы точно выбрали правильный язык?',
    'call_lang_check_change': 'Сменить язык',
  ...
  static const Map<String, String> _zh = {
    ...
    'match_cta': '配对',
    'match_matched': '已配对',
    'demandes_wants_to_match': '{name} 向你发送了请求',
    ...
    'call_declined': '通话被拒绝',
    'call_no_answer': '无人接听',
    'call_lang_check_q': '你确定选对语言了吗？',
    'call_lang_check_change': '更改语言',
  ...
  static const Map<String, String> _ja = {
    ...
    'country_fr': 'フランス',
    'country_de': 'ドイツ',
    'globe_launch': 'プロフィールを見る',
    'globe_filter_cta': '絞り込む',
    'globe_hint': '1つ以上の国をタップ。ピンチで拡大。',
    'globe_title': 'どの国？',
    ...
    'match_cta': 'マッチする',
    'match_matched': 'マッチ済み',
    'demandes_wants_to_match': '{name}さんからリクエストが届きました',
    ...
    'call_no_answer': '応答なし',
    'call_lang_check_q': '話す言語は正しく選ばれていますか？',
    'call_lang_check_change': '言語を変更',
  ...
  static const Map<String, String> _ko = {
    ...
    'globe_launch': '프로필 보기',
    'globe_filter_cta': '필터',
    'globe_hint': '하나 이상의 국가를 탭하세요. 손가락으로 확대.',
    'globe_title': '어떤 나라?',
    ...
    'match_cta': '매치하기',
    'match_matched': '매치됨',
    'demandes_wants_to_match': '{name}님이 요청을 보냈어요',
    ...
    'call_lang_check_q': '말하는 언어를 올바르게 선택했나요?',
    'call_lang_check_change': '언어 변경',
